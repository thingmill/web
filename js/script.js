MinecraftAPI.getServerStatus('193.107.59.60', {}, function(err, status) {
    if (err) {
...
lastDropdownEntry.addEventListener("click", function() {
    ...
    var contributors = [{
        ...
        "name": "Action-bar",
        "url": "https://dev.bukkit.org/projects/actionbar"
    }, {
		"name": "Five Night At freddy's",
        "url": "https://dev.bukkit.org/...plugins/five-nights-freddys-in-minecraft"
    }, {
		"name": "AntiX-Ray",
